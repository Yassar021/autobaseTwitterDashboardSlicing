import { Box, Button, Center, Flex, FormControl, HStack, Input, Link, Stack, Text } from "@chakra-ui/react"
        ...
        <AuthLayout pageTitle={'Forgot Password'}>
            <Flex direction={'column'} gap='48px' alignItems={'center'}>
                ...
                <Box w={{sm:'420px',md:'557px'}} h='527px' bgColor={'#fff'} pt={{base:'30px',md:'48px'}} px={{base:'40px',md:'70px'}} pb='44px' borderRadius={'16px'} shadow='lg'>
                    <Text align={'center'} fontSize={'32px'} fontWeight='500' color='#3786E5'>Forgot Password</Text>
                    ...
                    <Box mt='54px'>
                        ...
                        <Link href='/'>
                            <Text mt='16px' color='#B5BBC2' fontSize={'16px'}><u>Back to login</u></Text>
                        </Link>
                    </Box>
                </Box>
            </Flex>
