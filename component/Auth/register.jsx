import { Box, Button, Center, Checkbox, Flex, FormControl, HStack, Input, Link, Stack, Text } from "@chakra-ui/react"
        ...
        <AuthLayout pageTitle={'Register'}>
            <Flex direction={'column'} gap='48px' alignItems={'center'}>
                ...
                <Box w={{sm:'420px',md:'557px'}} h='527px' bgColor={'#fff'} pt={{base:'30px',md:'48px'}} px={{base:'40px',md:'70px'}} pb='44px' borderRadius={'16px'} shadow='lg'>
                    <Text align={'center'} fontSize={'32px'} fontWeight='500' color='#3786E5'>Register</Text>

                    <Box mt='54px'>
                        <Box>
                            <FormControl isRequired>
                                <Input borderRadius={'8px'} h='56px'  borderColor={'#ABC9ED'} id='name' _placeholder={{color:'#3786E5',fontSize:'18px'}} placeholder="Name"  />
                            </FormControl>
                        ...
                        <Text mt='16px' color='#B5BBC2' fontSize={'16px'}>Sudah punya akun? <Link color='#6484AA' href='/'><u>Login</u></Link></Text>
                    </Box>
                </Box>
            </Flex>
        </AuthLayout>
