...
const Quotes = () => {
    ...
    return ( 
        <AuthDashboard pageTitle={'Manage Quotes'}>
            <Box>
                <Text fontSize={'28px'} fontWeight='700' fontFamily={'DM Sans'} color='#6484AA'>MANAGE QUOTES</Text>
            </Box>
                    ...
                    <Table size='lg' variant='simple'>
                        ...
                        <Thead>
                            <Tr>
                                ...
                                <Th color={'#6484AA'} fontSize='16px'>Company</Th>
                                <Th color={'#6484AA'} fontSize='16px'>Problem</Th>
