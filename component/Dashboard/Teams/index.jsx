...
const Teams = () => {
    ...
    return ( 
        <AuthDashboard pageTitle={'Manage Teams'}>
            <Box>
                <Text fontSize={'28px'} fontWeight='700' fontFamily={'DM Sans'} color='#6484AA'>MANAGE TEAMS</Text>
            </Box>

            <Box  mt='48px'>
                <Box mb='32px'>
                    <Link href="/addTeams" _hover={{textDecoration:'none'}}>
                        <Button 
                                leftIcon={<AddIcon />}
                                size='md'
                                height='56px'
                    ...
                    <Table size='lg' variant='simple'>
                        ...
                        <Thead>
                            <Tr>
                                ...
                                <Th color={'#6484AA'} fontSize='16px'>Profile</Th>
                                <Th color={'#6484AA'} fontSize='16px'>Name</Th>
                                <Th color={'#6484AA'} fontSize='16px'>Position</Th>
