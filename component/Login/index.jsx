            ...
            <Flex direction={'column'} gap='48px' alignItems={'center'}>
                <Center>
                    <HStack spacing='16px' textAlign={'center'}>
                        ...
                        <Text fontSize={'32px'} fontWeight='500' color='#fff'>Autobase Reborn</Text>
                    </HStack>
                </Center>
                <Box w='557px' h='527px' bgColor={'#fff'} pt='48px' px='70px' pb='44px' borderRadius={'16px'} shadow='lg'>
                    <Text align={'center'} fontSize={'32px'} fontWeight='500' color='#3786E5'>Admin Area</Text>
                    ...
                    <Box mt='54px'>
                        <Box>
                            ...
                            <Checkbox  size='md' colorScheme='#ABC9ED' fontSize={'16px'} color='#C2C8CF' defaultChecked>
                                Keep me loged in
                            </Checkbox>
                        </Box>
                        <Button mt='16px'
                        ...
                        <Text mt='16px' color='#B5BBC2' fontSize={'16px'}>Belum punya akun? <Link color='#6484AA'><u>Buat akun baru</u></Link></Text>
                    </Box>
                </Box>
            </Flex>
        </AuthLayout>
